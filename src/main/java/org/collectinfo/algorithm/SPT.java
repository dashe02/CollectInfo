package org.collectinfo.algorithm;
...
public class SPT {
    ...
    *  @param dt[6]
    *            dt[0]返回偏差平方和q,dt[1]返回平均标准偏差a,dt[2]返回回归
    *            平方和p,dt[3]返回最大偏差umax，dt[4]返回最小偏差umin,dt[5]返回偏差
    * 平均值u
    */
    ...
    *        dt[0]偏差平方和q,dt[1],平均标准偏差s, dt[2]返回复相关系数r
      ...
      *      返回m个自变量的偏相关系数
    * */
     public static void SPT2(double[][] x,double[] y,int m,int n,double[] a,double[] dt,double[] v){
          int i,j,k,mm;
    ...
    public static int chlk(double[] a,int n,int m,double[] d){
        int i,j,k,u,v;
    ...
    public static void main(String[] args){
        ...
        */
        ...
        double [][] x={{1.1,1.0,1.2,1.1,0.9},{2.0,2.0,1.8,1.9,2.1},{3.2,3.2,3.0,2.9,2.9}};
        double [] y={10.1,10.2,10.0,10.1,10.0};
        SPT.SPT2(x,y,3,5,a,dt,v);
        for(i=0;i<=3;i++)
